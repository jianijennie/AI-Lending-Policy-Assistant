...
- BFS Plus: commercial contracts on used vehicles require minimum CCR 550 (not the standard 400 — see bfs_customer_tiers); passenger and light commercial only; no high-value loans; no Low Doc
